...
class UserRegisterForm(forms.ModelForm):
	username = forms.CharField(label='@Usuario *', widget=forms.TextInput(attrs={'placeholder': 'Nombre de Usuario', 'class': 'form-control'}), validators=[RegexValidator(regex='^.{4,10}$', message='Este campo debe tener 4 a 10 carácteres', code='nomatch')])
